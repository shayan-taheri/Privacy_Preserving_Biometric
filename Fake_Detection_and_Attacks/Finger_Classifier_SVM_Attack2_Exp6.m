...
MaltestFeatures = zeros(size(testFeatures,1),size(testFeatures,2));
for im = 1:size(testFeatures,2)
    MaltestFeatures(:,im) = feature_mal_meanmax(testFeatures(:,im));
end

MaltestFeatures = MaltestFeatures';
