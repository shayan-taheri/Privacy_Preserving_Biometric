...
classdef imageCategoryClassifierInfected < vision.internal.EnforceScalarHandle
    ...
    methods       
        ...
        function [label, score] = predict(this, img, varargin)
            ...
            params = imageCategoryClassifierInfected.parseCommonParameters(...
        ...
        function [confMat, knownLabel, predictedLabel, score] = evaluate(this, testSets, varargin)
            ...
            params  = imageCategoryClassifierInfected.parseCommonParameters(true, varargin{:});
            ...
            if isImageSet
                ...
                if imageCategoryClassifierInfected.getNumCategories(testSets) ~= this.NumCategories
    ...
    methods (Hidden, Static)
        ...
        function this = create(imgSet, bag, varargin)
            this = imageCategoryClassifierInfected(imgSet, bag, varargin{:});
        end
        ...
        function params = parseInputs(varargin)
            ...
            parser.addParameter('LearnerOptions', templateSVM(), @imageCategoryClassifierInfected.checkTemplateSVM);
        ...
        function this = loadobj(s)
            ...
            this = imageCategoryClassifierInfected();     
            
            % Invoke customized loadobj for bagOfFeatures
            this.Bag = bagOfFeaturesInfected.loadobj(s.Bag);
    ...
    methods (Access = protected)
        ...
        %------------------------------------------------------------------
        % Constructor
        function this = imageCategoryClassifierInfected(imgSet, bag, varargin)
            if nargin ~= 0
                params = imageCategoryClassifierInfected.parseInputs(varargin{:});
                
                varName = 'imds';
                
                validateattributes(bag, {'bagOfFeaturesInfected'}, {'nonempty'}, mfilename, 'bag');
                validateattributes(imgSet, {'imageSet', 'matlab.io.datastore.ImageDatastore'}, ...
                    {'nonempty','vector'}, mfilename, varName);
                
                if imageCategoryClassifierInfected.isImageSet(imgSet)
        ...
        function [fvectors, labels] = createFeatureVectors(this, imgSet, ...
            ...
            if imageCategoryClassifierInfected.isImageSet(imgSet) % TODO refactor and move to internal
                % initialize outputs                
