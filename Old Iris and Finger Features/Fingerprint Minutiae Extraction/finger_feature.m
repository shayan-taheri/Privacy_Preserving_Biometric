...
function finger_features_out = finger_feature(finger_img_name)
...
finger_features_out = median(bifurcation_y); % Extracted Features
finger_features_out = double(ceil(finger_features_out));
