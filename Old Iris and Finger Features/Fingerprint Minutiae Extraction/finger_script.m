...
binary_image = binary_image(size(binary_image,1),size(binary_image,2)/2);
...
finger_feature_out = ridge_features .* bifurcation_features; % Extracted Features
